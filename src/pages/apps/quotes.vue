<script setup>
import { baseUrl, QuoteEndpoints } from "@/stores/userStore"
...
const fetchContacts = endpointC => {
  ...
  if (endpointC === 'auditvisionai') {
    endpoint = QuoteEndpoints.auditvisionai
  } else if(endpointC === 'isevolutionsconsult'){
    endpoint = QuoteEndpoints.isevolutionsconsult
  }
        ...
        <template #item.actions="{ item }">
          ...
          >
            ...
            <VMenu activator="parent">
              <VList>
                <VListItem :to="{ name: 'reply-quote', query: { quote : item.raw.uid,site: selectedSite,mail:item.raw.email } }">
                  <template #prepend>
